...
from geloauth.data import OAuthRequestToken,  OAuthAccessToken
...
class OAuthClient(object):
    ...
    def logout(self, return_to='/oauth'):
        self.expire_cookie()
    ...
    def get_request_token(self):
        ...
        cookie = dict(token.split('=') for token in token_info.split('&'))
    ...
    def callback(self, return_to='/oauth'):
